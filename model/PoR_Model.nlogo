...
globals [ ; Globals are generally used for the connection with PyNetLogo
  total-co2-emitted-to-air-global ; int [ton of CO2]
  total-co2-stored-global ; int [ton of CO2]
  total-subsidy-to-por-global ; int [eur]
  total-subsidy-to-industries-global ; int [eur]
]
